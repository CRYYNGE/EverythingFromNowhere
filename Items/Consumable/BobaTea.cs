...
namespace EverythingFromNowhere.Items.Consumable
{
	public class BobaTea : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Boba Tea");
			Tooltip.SetDefault("A delicious drink with tapioca balls in it. Calms the nerves.");
